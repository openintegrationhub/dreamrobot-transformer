...
module.exports.getExpression = msg => {
  ...
  const expression = {
    ...
    invoiceAmount:            msg.body.order.invoice_amount,
    ...
    references: [
      {
        externalId:               msg.body.order.username,
    ...
    shipping:
      {
        ...
        address: {
          ...
          countryCode:        '',
          primaryContact:     msg.body.order.shipping.address.name + ' ' + msg.body.customer.address.name_2,
          label:              'primary'
        }

      },
    lineItems:                jsonata(`$map("${body.order.line}", function($line, $index, $dataset) {
   		{
        	"name": $line.name,
            "sku":  $line.sku,
    ...
    customer: {
      ...
      addresses:[{
          ...
          countryCode:        '',
          primaryContact:     msg.body.order.customer.address.name + ' ' + msg.body.customer.address.name_2,
          label:              'primary'
      }],
      contactData: [{
