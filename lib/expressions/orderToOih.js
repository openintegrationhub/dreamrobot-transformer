...
module.exports.getExpression = msg => {
  ...
  const expression =  jsonata(`{
    ...
    "status": [
      body.order.status.is_paid = null ? undefined :{
      "qualifier":              'paid',
    ...
    "shipping":
      {
        ...
        "address": {
          ...
          "primaryContact":     body.order.shipping.address.name = null && body.order.shipping.address.name_2 = null ? body.order.shipping.address.name & ' ' & body.order.shipping.address.name_2,
          "label":              'primary'
        }
