...
module.exports.getExpression = msg => {
  ...
  const expression =  jsonata(`{
     "meta": {
      ...
      "applicationUid": (meta.applicationUid!=undefined and meta.applicationUid!=null) ? meta.applicationUid : 'appUid not set yet',
      "iamToken": (meta.iamToken!=undefined and meta.iamToken!=null) ? meta.iamToken : 'iamToken not set yet',
      "lastModification": {
