...
module.exports.getExpression = msg => {
  ...
  const expression = jsonata(`{
    "order" : {
      ...
      "id": body.oihApplicationRecords[0].recordUid,
      ...
      "status": {
        ...
        "is_initial_contact": body.status[qualifier='initial_contact'].value,
        ...
        "initial_contact_date": $fromMillis($toMillis(body.status[qualifier='initial_contact'].qualifiedOn),'[Y0001]-[M01]-[D01]'),
